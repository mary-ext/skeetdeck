...
const Checkbox = (props: ComponentProps<'input'>) => {
	return (
		<label class="relative inline-flex shrink-0 cursor-pointer text-xl">
			...
			<div class="pointer-events-none absolute -inset-2 rounded-full outline-2 -outline-offset-2 outline-accent peer-hover:bg-secondary/20 peer-focus-visible:bg-secondary/20 peer-focus-visible:outline" />
